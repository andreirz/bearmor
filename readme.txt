...
### Advanced Firewall
- **Real-time threat blocking** at the application level
- Block malicious requests before they reach WordPress
- Country blocking and IP reputation filtering
- Custom rules for your specific needs

### Deep Vulnerability Scanner
- **Database scanning** for injected malware
- **Comprehensive plugin/theme vulnerability checks**
- Checks against known CVE databases
- Proactive alerts for zero-day threats

### AI-Powered Analysis
- **ChatGPT integration** analyzes your security data
- Get **personalized recommendations** in plain English
- Understand threats without technical knowledge
- "What should I do?" answered instantly

### 24/7 Uptime Monitoring
- External monitoring from our servers
- Instant email alerts when your site goes down
- Historical uptime data and reports
...
| Feature | Bearmor FREE | Wordfence FREE | Sucuri FREE |
|---------|--------------|----------------|-------------|
| Malware Scanner | ✅ Full | ✅ Limited | ❌ PRO only |
| File Monitoring | ✅ Full | ✅ Yes | ❌ PRO only |
| Login Protection | ✅ Full | ✅ Yes | ✅ Basic |
| 2FA | ✅ FREE | ❌ PRO only | ❌ PRO only |
| Quarantine | ✅ FREE | ❌ PRO only | ❌ PRO only |
| Performance Impact | ⚡ Minimal | 🐌 Heavy | ⚡ Light |
...
- **Email:** support@bearmor.eu (PRO users get priority)
...
### After Activation
1. You'll see the Bearmor Security menu in your admin sidebar
2. Run your first malware scan from the dashboard
3. Review and apply recommended hardening settings
4. Enable 2FA for your account (optional but recommended)
...
= Is Bearmor Security really free? =
...
= What data does Bearmor send to your servers? =
...
= How is the AI analysis different? =
...
1. **Security Dashboard** - Clean, at-a-glance overview of your security status
2. **Malware Scanner** - Detailed threat detection with one-click quarantine
3. **File Changes** - Real-time monitoring of all file modifications
4. **Login Security** - Track login attempts and block suspicious activity
5. **Hardening Options** - Simple toggles for common security fixes
6. **Security Score** - Letter grade showing your overall security posture
7. **AI Analysis (PRO)** - ChatGPT-powered security recommendations
...
* Improved: Logging for uptime sync debugging

= 0.7.1 - 2025-11-09 =
* Changed: Admin bar now only shows HIGH severity malware threats
* Improved: Reduced false positive alerts in admin notifications

= 0.7.0 - 2025-11-09 =
* Added: Complete uptime monitoring system with 7-day history
* Added: View History popup showing 30 days of uptime data
* Fixed: Uptime calculation now uses actual ping data
* Fixed: Chart loading race condition
* Improved: Accurate uptime percentages and display

= 0.6.9 - 2025-11-08 =
* Fixed: Antivirus false positives in placeholder code
* Added: Whitelist for popular security plugins
* Improved: Malware detection accuracy

= 0.6.8 - 2025-11-07 =
* Fixed: Database insertion errors for AI analysis
* Improved: UTF-8 character handling in scan results
* Added: Better error logging for debugging

= 0.6.7 - 2025-11-06 =
* Added: Admin bar quick access with threat count
* Changed: Menu position moved to bottom of admin menu
* Improved: Navigation and accessibility

= 0.6.0 - 2025-11-01 =
* Initial public release
* Complete malware scanner with quarantine
* File integrity monitoring
* Login security and 2FA
* Security hardening options
* Activity logging
* Security dashboard and scoring
...
= 0.7.2 =
Important fix for uptime monitoring. Existing users should update and refresh admin page to create missing database table.

= 0.7.0 =
Major update: Complete uptime monitoring system with accurate calculations and historical data.

= 0.6.0 =
First public release. Welcome to Bearmor Security!
...
All external connections use HTTPS encryption. FREE users only connect for initial registration (URL + email). No security data leaves your server unless you upgrade to PRO.
